...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def computeQValueFromValues(self, state, action):
        ...
        for nextState, probability in self.mdp.getTransitionStatesAndProbs(state, action):# for every possible outcome of the action
    ...
    def computeActionFromValues(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        policies = util.Counter() # basicaly a dictionary
